  ...
  useEffect(() => {
    (function (params) {
      let navigationLists = [
        ...
        { title: "Setting", link: `/${auth.userId}/setting` },
        { title: "Address", link: `/${auth.userId}/address` },
        {
          title: "Followers",
          link: `/${auth.userId}/followers`,
        },
        { title: "Following", link: `/${auth.userId}/following` },
        { title: "Stared Articles", link: `/${auth.userId}/staredArticles` },
        {
          title: "Library",
          link: `/${auth.userId}/library`,
        },
        { title: "Analytics", link: `/${auth.userId}/analytics` },
