...
import GetCryptoCurrencyByTagItem from './GetCryptoCurrencyByTagItem';

const GetCryptoCurrencyByTagList = (props) => {
    return (
      <div>
        {props.tagSortedCrypto.map((c, index) => (
          <GetCryptoCurrencyByTagItem
            key={c.index}
            name={c.name}
...
export default GetCryptoCurrencyByTagList;
