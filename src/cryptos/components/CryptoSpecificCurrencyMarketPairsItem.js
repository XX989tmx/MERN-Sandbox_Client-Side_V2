...
import './CryptoSpecificCurrencyMarketPairsItem.css';

const CryptoSpecificCurrencyMarketPairsItem = (props) => {
    return (
      <div className="crypto-specific-market-pairs-item-container">
        <Section1GeneralArea
          icon={props.icon}
          name={props.name}
          code={props.code}
        ...
        <div className="section3-market-pairs-area">
          <h2>{props.name} Market Pairs Area</h2>
        </div>
...
export default CryptoSpecificCurrencyMarketPairsItem;
