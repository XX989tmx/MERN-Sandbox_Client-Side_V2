  ...
  if (token) {
    routes = (
      <Switch>
        ...
        <Route path="/getSpecificUser/:userId" exact>
          <GetSpecificUser />
        </Route>
        <Route path="/articleCommentHistory/:userId" exact>
          <ArticleCommentHistoryOfThisUser />
        </Route>
        ...
        <Route path="/:userId/staredVideos" exact>
          <StaredVideos />
        </Route>
        ...
        <Route path="/cryptos/currencies/:queryName/market-pairs" exact>
          <CryptoSpecificCurrencyMarketPairs />
        </Route>
        <Route path="/cryptos/currencies/:queryName/historical-data" exact>
          <CryptoSpecificCurrencyHistoricalData />
        </Route>
